...
# =========================
# 入力TXTと出力PNGのファイル名。
# 出力側を指定したい場合は記入。空の場合はINPUT_TXT_PATHから決定
INPUT_TXT_PATH = "input.txt"
OUTPUT_PNG_PATH = ""

# 縦書きか横書きか "vertical" | "horizontal"
WRITING_MODE = "horizontal"

# 画像の幅と高さ(px)
IMG_WIDTH = 1024
IMG_HEIGHT = 1024
# 背景色と文字の色 (R,G,B,A) 例: #FFFF00
# 透過にする場合は（A=0）
...
ENABLE_STROKE = True
STROKE_WIDTH = 8
STROKE_FILL = (128, 128, 128, 255)             # 縁取りの色
# =========================
...
def get_output_file_path():
    ...
    if (OUTPUT_PNG_PATH):
        ret_str = OUTPUT_PNG_PATH
    else:
        # Pathオブジェクトに変換
        p = Path(INPUT_TXT_PATH)
        # 拡張子を変更
        ret_str = p.with_suffix(".png")
